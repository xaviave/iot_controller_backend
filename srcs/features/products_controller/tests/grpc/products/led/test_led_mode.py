...
class TestLedMode(TransactionTestCase):
    ...
    async def test_async_destroy_led_mode(self):
        ...
        request = products_controller_pb2.LedModeDestroyRequest(uuid=create_res.uuid)
    ...
    async def test_async_partial_update_led_mode(self):
        ...
        res = await grpc_stub.Retrieve(products_controller_pb2.LedModeRetrieveRequest(uuid=create_res.uuid))
        json_res = self.clean_response(json_format.MessageToDict(res))
        ...
        # Query one LedMode Object in dataset
        res = await grpc_stub.Retrieve(products_controller_pb2.LedModeRetrieveRequest(uuid=partial_update_res.uuid))
        json_res = self.clean_response(json_format.MessageToDict(res))
    ...
    async def test_async_update_led_mode(self):
        ...
        update_res = await grpc_stub.Update(products_controller_pb2.LedModeRequest(uuid=create_res.uuid, name="up"))

        # Query one LedMode Object in dataset
        res = await grpc_stub.Retrieve(products_controller_pb2.LedModeRetrieveRequest(uuid=update_res.uuid))
        json_res = self.clean_response(json_format.MessageToDict(res))
